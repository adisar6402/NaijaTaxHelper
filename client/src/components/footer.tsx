            ...
            <div className="space-y-2">
              <p className="text-sm text-gray-500">
                <span className="inline-flex items-center gap-2">
                  {t.footer.builtBy}
                  <a href="https://www.linkedin.com/in/abdulrahman--engineering-ai-ml/" target="_blank" rel="noopener noreferrer" className="hover:opacity-80">
                  ...
                  <a href="https://github.com/adisar6402" target="_blank" rel="noopener noreferrer" className="hover:opacity-80">
